Feature: Gerenciamento de Álbuns e Músicas
  ...
  Scenario: Edição de informações válidas de um álbum existente com sucesso
    ...
    And as músicas do álbum de ID "12" são "Spring" de índice "1" e "Winter" de índice "2"
    When tento alterar o nome do álbum de ID "4" para "Le quattro stagioni" e o gênero para "Barroco"
    Then o álbum "Le quattro stagioni" publicado por "vivaldi" deve estar visível na plataforma com gênero "Barroco" e ID "4"
    And as músicas do álbum de ID "12" são "Spring" de índice "1" e "Winter" de índice "2"

  Scenario: Cadastro de álbum com músicas com sucesso
    Given estou logado como "Artista" com login "vivaldi"
    When tento publicar um álbum chamado "Four Seasons" de ID "1", com gênero "Barroco", data de lançamento "1725-01-01", contendo as músicas "Winter" com arquivo "winter.mp3" e "Summer" com arquivo "summer.mp3"
