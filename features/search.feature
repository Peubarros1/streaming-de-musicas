Scenario: Exibição da página inicial para usuário logado
...
Scenario: Exibição da página inicial para usuário nao logado
...
Scenario: Busca que não retorna resultados // implementacao do cenario
Given estou logado como “Usuário” com login “LuisCardoso012” e senha “1234”
...
Scenario: Busca com filtro de gênero inexistente
...
Scenario: Busca por músicas utilizando filtro de ano de lançamento com resultados
Given estou logado como "Usuário" com login "LuisCardoso012" e senha "1234"
...
Scenario: Exibição do histórico de filtros ao abrir a busca
Given estou logado como “Usuário” com login “LuisCardoso012” e senha “1234”
...
Scenario: Busca por músicas utilizando filtro de gênero com resultados
Given estou logado como "Usuário" com login "LuisCardoso012" e senha "1234"
...
Scenario: Busca por músicas utilizando filtro de nome do artista
Given estou logado como "Usuário" com login "LuisCardoso012" e senha "1234"
...
Scenario: Busca por música utilizando filtro de gênero e campo de nome com resultados
Given estou logado como "Usuário" com login "LuisCardoso012" e senha "1234"
...
Scenario: Empate em número de reproduções no ranking Em Alta
...
Scenario: Ultrapassagem de número de reproduções no ranking Em Alta
...
Scenario: Exibição da página de busca
Given estou logado como “Usuário” com login “LuisCardoso012” e senha “1234”
...
Scenario: Recomendação de músicas com base em um único gênero
